...
<div id="changesSummary" class="changesSummary">
    [#if totalCommitsCount gt commitsCount]
        [@ww.text var='deploymentVersionFilesSkipped' name='buildResult.changes.files.skipped' ]
...
[#macro defaultCommitDisplay changesets repositoryChangeset repositoryData]
    [#if repositoryChangeset.commits?has_content]
        [#assign commitToUrls = action.getUrlsForChangeset(repositoryChangeset)!/]
...
<tr>
    ...
    <td class="revision">
        ...
        [#if revision?has_content]
            [#assign commitUrl = (commitToUrls.get(revision))! /]
