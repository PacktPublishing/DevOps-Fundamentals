...
${soy.render("bamboo.deployments:configure-deployment-project", "bamboo.page.deployment.project.configureDeploymentProject", {
    ...
    "repositoryStoredSpecsEnabled": featureManager.repositoryStoredSpecsEnabled,
    "deploymentPluginsAvailable": anyCustomEnvironmentConfigPluginAvailable,
    "dockerPipelinesEnabled" : featureManager.dockerPipelinesEnabled
})}
</body>
</html>
