...
[#if id gt 0]
    ...
    [#assign saveOrCreateActionName="saveDeploymentProjectDetails"/]
[#else]
    [#assign cancelUri="/deploy/viewAllDeploymentProjects.action" /]
    [#assign saveOrCreateActionName="createDeploymentProjectDetails"/]
[/#if]
...
[@s.form id="configureDeploymentProjectDetails" 
    action=saveOrCreateActionName namespace="/deploy/config"
