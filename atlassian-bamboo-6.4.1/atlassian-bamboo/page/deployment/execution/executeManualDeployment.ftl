...
[@ww.url var="createVersionUrl" action="createDeploymentVersion" namespace="/deploy" deploymentProjectId=deploymentProject.id /]
            ...
            <div class="aui-item aui-item-select-release">
                ...
                [#if versionId == 0]
                    ...
                    <div class="radio">
                        ...
                        [#assign canCreateNewRelease = (canCreateFromBranches || action.hasDefaultPlanBuildResults()) && action.hasPlanPermission('READ', linkedPlan)]
                        <input id="releaseTypeCreateOption"
                            ...
                            [#if !canCreateNewRelease]disabled=disable[/#if]
                        >
