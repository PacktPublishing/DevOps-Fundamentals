...
<html>
<head>
    [@ww.text var='header' name='deployment.result.header'][@ww.param value=deploymentResult.environment.name /][@ww.param]${deploymentResult.deploymentVersion.name?html}[/@ww.param][/@ww.text]
...
<script type="text/javascript">
    require(['jquery', 'page/deployment/view-deployment-result'], function($, deploymentResult){
        deploymentResult.init({
            ...
            environment: $.parseJSON("${action.toJson(environment)?js_string}"),
