...
[#macro jiraDeleteOperation issue buildResultsSummary]
    [@ww.url var='removeUrl' value='/build/removeJiraIssue.action?buildKey=${buildResultsSummary.planKey!}&buildNumber=${buildResultsSummary.buildNumber}&currentIssueKey=${issue.issueKey}' /]
...
[#macro jiraIssueSummary resultsSummary linkedJiraIssues maxIssues]
    [#if linkedJiraIssues?has_content && jiraIssueUtils.isJiraServerSetup()]
        [@ww.url var='jiraTabUrl' value='/browse/${resultsSummary.planResultKey}/issues' /]
...
"issuesCount": issuesCount
    ...
    [@ww.url var='getIssuesUrl' value='/rest/api/latest/result/' /]
