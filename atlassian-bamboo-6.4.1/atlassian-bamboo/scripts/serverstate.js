...
BAMBOO.ADMIN.SERVERSTATE.serverState = (function ($) {
    var defaults = {
            ...
            preparingForRestartMessage: AJS.I18n.getText('serverstate.preparingForRestart.message'),
            readyForRestartMessage: AJS.I18n.getText('serverstate.readyForRestart.message'),
