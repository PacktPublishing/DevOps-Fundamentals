...
<section id="content" role="main">
    ...
    <div class="aui-panel">
        [@ww.url value='/agent/viewAgents.action' var='agentsListUrl' /]
        [@agt.header /]
        [@agt.agentDetails headerKey='agent.details' agentId=agent.id showOptions="short" /]
        [@menu.displayTabbedContent location="agent.subMenu" selectedTab=page.properties["meta.tab"] analyticsEvent="bamboo.page.viewAgent.tabsactivate"]
            ${body}
