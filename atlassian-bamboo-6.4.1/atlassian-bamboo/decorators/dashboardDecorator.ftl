...
[#assign footerContent]
    ...
    [/#if]
    <p>
        <a href="${req.contextPath}/rss/createAllBuildsRssFeed.action?feedType=rssAll${rssSuffix}">[@ui.icon useIconFont=true type="rss" text="Point your rss reader at this link"/]</a>
