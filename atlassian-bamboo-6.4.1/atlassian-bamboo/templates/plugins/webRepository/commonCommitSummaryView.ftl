...
[#macro displayCommitSummary buildResultsSummary repositoryChangeset commitToUrls maxChanges]
        ...
        <table class="aui code-changes">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="revision">
                        [#-- we called guessChangeSet before so now we can simly get it --]
                        [#assign guessedRevision = commit.getChangeSetId()!("")]
                        [#if guessedRevision?has_content]
                            [#assign commitUrl = (commitToUrls.get(guessedRevision))! /]
