...
[/#if]
[@s.textfield labelKey='repository.svn.repository' name='repository.svn.repositoryRoot' cssClass="${svnUrlCssClass}" required=true /]
...
[@ui.bambooSection dependsOn='repository.svn.authType' showOn='password']
    [#if stack.findValue('repository.svn.userPassword')?has_content]
...
[@ui.bambooSection dependsOn='repository.svn.authType' showOn='ssh']
    ...
    [#if stack.findValue('repository.svn.passphrase')?has_content]
...
[@ui.bambooSection dependsOn='repository.svn.authType' showOn='ssl-client-certificate']
    ...
    [#if stack.findValue('repository.svn.sslPassphrase')?has_content]
