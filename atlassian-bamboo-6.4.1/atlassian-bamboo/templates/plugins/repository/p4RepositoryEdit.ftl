...
[#if buildConfiguration.getString('repository.p4.password')?has_content]
    [@s.checkbox labelKey='repository.password.change' toggle='true' name='temporary.p4.passwordChange' /]
...
[@s.checkbox labelKey='repository.p4.useClientMapping' name='repository.p4.useClientMapping' helpKey='perforce.fields' /]
