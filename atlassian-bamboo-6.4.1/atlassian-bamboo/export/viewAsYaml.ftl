...
<head>
    [@ui.header pageKey='yaml.config.export.view.header' object='${objectName!""}' title=true /]
...
<body style="overflow: hidden;">
    [@ace.textarea name="exportItem" resizable=false isReadonly=true mode="ace/mode/yaml" growVertical=true /]
</body>
