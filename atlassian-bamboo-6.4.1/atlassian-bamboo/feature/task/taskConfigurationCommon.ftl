...
[#macro editTasksCommon taskSelectorUrl agentAvailabilityDescriptionUrl editTaskUrl deleteTaskUrl moveTaskUrl moveFinalBarUrl]
    ...
    [/@ww.text]
    [#assign filterForm]
    <form id="filter-task-type" class="aui"><input type="search" class="text" placeholder="[@ww.text name='global.buttons.search' /]"/>
    </form>[/#assign]
            ...
            <div class="aui-toolbar inline">
                <ul class="toolbar-group">
                    <li class="toolbar-item">
                        <a href="${taskSelectorUrl}" id="addTask" class="aui-button toolbar-trigger">[@ww.text name="tasks.add" /]</a>
                    </li>
                </ul>
            </div>
        </div>
