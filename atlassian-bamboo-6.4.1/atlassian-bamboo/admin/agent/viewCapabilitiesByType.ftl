...
<body>
    ...
    <script type="text/javascript">
        ...
        if('jdk' == '${capabilityTypeString?js_string}')
        {
            AJS.trigger('analytics',
                    {
                        name: 'bamboo.page.visited.viewCapabilitiesByType.jdks'
                    }
            );
        } else if('builder' == '${capabilityTypeString?js_string}')
        {
            AJS.trigger('analytics',
                    {
                        name: 'bamboo.page.visited.viewCapabilitiesByType.executables'
                    }
            );
        }
    </script>
