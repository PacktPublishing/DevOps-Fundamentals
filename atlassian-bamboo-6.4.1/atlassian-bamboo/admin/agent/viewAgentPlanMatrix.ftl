    ...
    <table class="aui">[#compress]
        ...
        <tbody>
            ...
            <tr>
                ...
                [@ww.url var='chainLink' value='/browse/${plan.key}'/]
                ...
                <tr>
                    <th class="jobHeading">
                    [@ww.url var='editBuildConfigurationUrl' action='editBuildConfiguration' namespace='/build/admin/edit' buildKey=build.key/]
                        [#if build.type.equals("JOB")]
                        [@ww.url var='chainLink' value='/browse/${build.parent.key}'/]
