[#-- @ftlvariable name="capabilityTypes" type="java.util.Collection<com.atlassian.bamboo.v2.build.agent.capability.CapabilityType>" --]

[@s.select name='capabilityType' key='agent.capability.type' list=capabilityTypes listKey='capabilityTypeKey' listValue='capabilityTypeLabel' toggle=true/]
...
[#list capabilityTypes as capabilityType]
    ...
    [#elseif capabilityType.capabilityTypeKey == 'jdk']
        [@ui.bambooSection  dependsOn='capabilityType' showOn='jdk']
            ...
            [@ww.textfield labelKey='agent.capability.type.jdk.value' name='jdkPath' cssClass='long-field' /]
        [/@ui.bambooSection]
    [#elseif capabilityType.capabilityTypeKey == 'builder']
        ...
        [@ui.bambooSection dependsOn='capabilityType' showOn='builder']
            ...
            [@ui.bambooSection  dependsOn='builderType' showOn=configurableBuilders]
                ...
                [@ww.textfield labelKey='agent.capability.type.builder.value' name='builderPath' cssClass='builderPath long-field' /]
    ...
    [#elseif capabilityType.capabilityTypeKey == 'perforce']
        [@ui.bambooSection dependsOn='capabilityType' showOn='perforce']
            [@ww.textfield labelKey='agent.capability.type.perforce.value' name='p4Executable' cssClass='long-field' /]
        [/@ui.bambooSection]
    [#else]
