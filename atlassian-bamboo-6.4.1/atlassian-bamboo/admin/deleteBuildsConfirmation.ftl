...
<body>
    ...
    [@ww.form titleKey='builds.delete.confirm.form.title' id='deleteBuildsForm' action='deleteBuilds' submitLabelKey='global.buttons.confirm' cancelUri='/admin/deleteBuilds!doDefault.action' cssClass="top-label"]
