[#-- @ftlvariable name="action" type="com.atlassian.bamboo.configuration.logs.ConfigureLog4jAction" --]
[#-- @ftlvariable name="" type="com.atlassian.bamboo.configuration.logs.ConfigureLog4jAction" --]

[@ui.header pageKey='logSettings.heading' descriptionKey='logSettigns.description' /]
<meta name="adminCrumb" content="logSettings">
        ...
        <tr>
            ...
            [@ww.form id='configureLog4jForm' action='saveLog4jClass' theme="simple" namespace="/admin" cssClass='aui' ]
                ...
                [@ww.submit type="submit" value=action.getText('global.buttons.update') cssClass='button' /]
                    <a id="deleteLogClass:${entry.clazz?html}" class="mutative" href="[@s.url namespace='/admin' action='deleteLog4jClass' toDeleteName=entry.clazz?html /]">[@ww.text name='global.buttons.delete'/]</a>
                [/@compress]
            [/@ww.form]
            </td>
        </tr>
