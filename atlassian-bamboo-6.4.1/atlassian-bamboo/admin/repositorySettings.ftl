...
<p>[@ww.text name='manageCaches.description' /]</p>
    ...
    <p>${cacheProvider.handlerDescription?html}</p>
        [@ww.form action="repositorySettingsDelete" id=provider theme="simple" namespace="/admin"]
...
<p>[@ww.text name='automaticCommits.description' /]</p>
    [@ww.form action="updateRepositorySettingsAutomaticCommits" id="automaticCommitsSettings" submitLabelKey="global.buttons.submit" namespace="/admin"]
...
<p>[@ww.text name='subversion.working.copies.description' /]</p>
    [@ww.form action="repositorySettingsUpdateSubversionPreferences" id="subversionWorkingCopySettings" submitLabelKey="global.buttons.update" namespace="/admin"]
