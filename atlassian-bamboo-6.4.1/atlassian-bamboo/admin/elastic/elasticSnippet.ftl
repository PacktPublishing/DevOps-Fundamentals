    ...
    <div class="aui-toolbar inline">
        <ul class="toolbar-group">
            <li class="toolbar-item">
                <a id="startElasticInstances" class="toolbar-trigger" href="[@ww.url action='prepareElasticInstances' namespace='/admin/elastic' /]">[@ww.text name='elastic.manage.createAgents' /]</a>
            </li>
...
[#if elasticErrors?has_content]
    [#list elasticErrors as error]
        [@cp.showSystemError error=error returnUrl="/admin/elastic/manageElasticInstances.action" webPanelLocation='elastic.errors'/]
    [/#list]
[/#if]
