...
[#macro elasticImageConfigurationViewProperties configuration displayConfigurationUrl=false short=false ]
    [#if displayConfigurationUrl]
        [@ww.url var='elasticConfigurationUrl' namespace='/admin/elastic/image/configuration' action='viewElasticImageConfiguration' configurationId=configuration.id /]
            ...
            <tr class="elasticRow [#if hasAgents || instance.agentLoading]elasticRowBottomless[/#if] [#if ebsError]ebsError[/#if]">
                ...
                <td>
                    [#if attachedVolumes?has_content]
                        [#list attachedVolumes as volume]
                            ${volume.ID}[#if volume_has_next]<br>[/#if][#t]
                        [/#list]
                    [#elseif ebsError]
                ...
                <td>
                    ...
                    [#if instanceStatus.launchTime?has_content]
                        [@ui.time datetime=instanceStatus.launchTime]${durationUtils.getRelativeDate(instanceStatus.launchTime)}[/@ui.time]
                    [/#if]
                </td>
...
[#macro editElasticInstance mode configuration='']
    ...
    [@s.form action="${action}"
        ...
        [@ww.text var="ebsLabel" name="elastic.image.configuration.ebsEnabled"]
        ...
        [#if configuration?has_content]
            ...
            [@s.checkbox key="elastic.image.configuration.per.second.billing" name="perSecondBillingEnabled"/]
            ...
            <tr>
                ...
                [#list currentSpotPrices.getProducts() as product]
                    ...
                    <td>
                        ...
                        [#if priceRange!="n/a"]
                            [@s.text name="elastic.configure.spot.instances.price.timestamp" var="priceTimestamp"]
