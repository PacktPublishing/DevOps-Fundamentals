    ...
    [#else]
        [@ui.bambooPanel]
            ...
            [#if disconnectedElasticInstances?has_content]
                [@ww.url var='shutdownAllDisconnectedElasticInstancesUrl' action='shutdownAllDisconnectedElasticInstances' namespace='/admin/elastic' returnUrl=currentUrl /]
                [@ui.bambooSection
            ...
            [#if detachedVolumes?has_content]
                [@ww.url var='deleteAllDetachedEbsVolumesUrl' action='deleteAllDetachedEbsVolumes' namespace='/admin/elastic' returnUrl=currentUrl /]
                [@ui.bambooSection
