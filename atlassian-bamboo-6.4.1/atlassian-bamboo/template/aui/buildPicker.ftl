...
<div class="aui-select2-item">
    ...
    <script type="text/javascript">
        require(['jquery', 'feature/build-autocomplete'], function($, BuildAutocomplete){
            return new BuildAutocomplete({
                el: $('#${parameters.id}')
                ...
                [#if parameters.masterPlanPickerId?has_content]
                    planKey: ${fn.jqueryObjectOrUndefined(parameters.masterPlanPickerId)}.val()
