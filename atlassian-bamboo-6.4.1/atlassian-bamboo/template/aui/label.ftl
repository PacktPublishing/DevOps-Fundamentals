[#if parameters.hideOnNull?? && parameters.hideOnNull?string == 'true' && (!parameters.nameValue?has_content || parameters.nameValue == '[]' || parameters.nameValue == 'false' || parameters.nameValue == '0')]
    [#else]
        ...
        [/#if]
        [#if parameters.description?has_content || parameters.descriptionKey?has_content || parameters.showDescription?has_content || parameters.helpDialog?has_content || parameters.helpDialogKey?has_content]
