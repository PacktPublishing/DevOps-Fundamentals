...
<body>
    ...
    <ul>
        ...
        <li>
            <a href="${req.contextPath}/rss/createAllBuildsRssFeed.action?feedType=rssAll&buildKey=${immutableBuild.key}${rssSuffix}">[@ui.icon useIconFont=true type="rss" text="Point your rss reader at this link to get the full ${immutableBuild.name} build feed" /]</a>
