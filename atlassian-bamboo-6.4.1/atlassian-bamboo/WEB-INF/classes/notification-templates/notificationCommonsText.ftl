...
[#-- ========================================================================================== @nc.showCommitsText --]
[#macro showCommits commits limit=3]
...
[#if limit?is_number][#if commit_index gte limit][#break][/#if][/#if]
[#assign guessedRevision = commit.guessChangeSetId()!("")]
${commit.authorContext.name}[#if guessedRevision?has_content] (${guessedRevision})[/#if]:
...
[#macro showAllSpecFailedBuilds failedBuilds]
[#-- @ftlvariable name="failedBuilds" type="java.util.List<com.atlassian.bamboo.notification.rss.RssAffectedPlan>" --]
...
${build.projectName} > ${build.name} [#if build.buildNumber??]#${build.buildNumber}[/#if][#if build.isRssMissingAnyAccess()] > Bamboo Specs execution failed due to missing permissions[/#if]
[/#list]
[/#if]
[/#macro]

[#-- =================================================================================== @nc.showAllSpecUpdatedBuilds --]
[#macro showAllSpecUpdatedBuilds affectedBuilds]
...
${build.projectName} > ${build.name} [#if build.buildNumber??]#${build.buildNumber}[/#if]
[/#list]
[/#if]
[/#macro]
...
[#macro showAllSpecFailedDeployments failedDeployments]
...
[#macro showAllSpecUpdatedDeployments affectedDeployments]
[#-- @ftlvariable name="failedDeployments" type="java.util.List<com.atlassian.bamboo.notification.rss.RssNotification.RssAffectedDeployment>" --]
