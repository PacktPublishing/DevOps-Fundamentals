...
[#macro configureVariables id variablesList createVariableUrl deleteVariableUrl updateVariableUrl overriddenVariablesMap tableId availableVariables=[] globalNotOverriddenVariables=[]]
    ...
    <script type="text/javascript">
        require(['jquery', 'feature/variables'], function($, variables){
            variables.VariablesConfigurationForm({
                selectors: {
                    form: "#${id?js_string}"
                },
                updateVariableUrl: "${updateVariableUrl?js_string}",
                overriddenVariablesMap: $.parseJSON("${action.toJson(overriddenVariablesMap)?js_string}"),
                globalNotOverriddenVariables: $.parseJSON("${action.toJson(globalNotOverriddenVariables)?js_string}")
    ...
    <tr class="add-variable">
        <td>
            ...
            [#elseif globalNotOverriddenVariables?has_content]
                ...
                <script type="text/javascript">
                    require(['jquery', 'widget/variable-single-select'], function($, VariableSingleSelect){
                        return new VariableSingleSelect({
                            el: '#variableKey',
                            bootstrap: $.parseJSON("${action.toJson(globalNotOverriddenVariables)?js_string}")
                        });
                    });
                </script>
            [#else]
