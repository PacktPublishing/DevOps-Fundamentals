...
[#macro permissionsEditor editablePermissions editablePermissionsForLoggedInUsers={} entityId=0 anonymousAllowed=true]
    ...
    [#if entityId > 0]
        [@ui.displayButtonContainer secondary=true]
            [@ww.url  var='addUserPrincipal' value='/ajax/addPermissionPrincipal.action?principalType=User&entityId=${entityId}&javaType=${entityAclType.name}&permissionToGrant=${minimalPermission.name}' returnUrl=currentUrl/]
            ...
            [@s.url var='addGroupPrincipal' value='/ajax/addPermissionPrincipal.action?principalType=Group&entityId=${entityId}&javaType=${entityAclType.name}&permissionToGrant=${minimalPermission.name}' returnUrl=currentUrl/]
