[#-- @ftlvariable name="action" type="com.atlassian.bamboo.ww2.actions.error.ErrorEventsAction" --]
[#-- @ftlvariable name="" type="com.atlassian.bamboo.ww2.actions.error.ErrorEventsAction" --]
    ...
    <table class="aui grid">
        ...
        <tr>
            ...
            [#if event.key.type == 'license-too-old']
                Please <a style="font-weight: bold;" href="${req.contextPath}/setup/updateLicense!doDefault.action">update your license</a>  and then restart Bamboo.
            [/#if]</td>
            <td>
