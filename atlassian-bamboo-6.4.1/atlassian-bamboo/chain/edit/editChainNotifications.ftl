...
[#assign createNotificationButton]
    [@ww.url var='addNotificationUrl' value='/chain/admin/ajax/addNotification.action' buildKey=buildKey returnUrl=currentUrl lastModified=lastModified conditionKey=conditionKey notificationRecipientType=notificationRecipientType previousTypeData=previousTypeData saved=true /]
