...
[/#if]
    [#-- ============================================================================================= Header Section --]
    [@ww.url var='currentBuildUrl' value='/browse/${buildResultKey}' /]
    ...
    [#if buildSummary?has_content && buildSummary.finished && testResults?? && testSummary.totalTestCaseCount > 0]
        <div class="tests">
            ...
            [@tests.displayTestInfo testSummary testQuarantineEnabled/]
    ...
    [#if buildSummary.inProgress]
        <div id="logs" class="section">
            ...
            [@ps.showBuildLog id="resultSummaryLogs_target" /]
    ...
    [#if buildSummary.active]
        ...
        [@ww.url var='getBuildUrl' value='/rest/api/latest/result/${buildResultKey}' /]
        [@ww.url var="reloadUrl" value="/browse/${buildResultKey}"/]
