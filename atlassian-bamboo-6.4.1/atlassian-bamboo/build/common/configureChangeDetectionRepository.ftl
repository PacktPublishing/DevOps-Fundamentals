        ...
        <div class="aui-toolbar inline">
            <ul class="toolbar-group">
                <li class="toolbar-item">
                    <a href="[@ww.url action="viewChainRepositorySelectors" namespace="/chain/admin/config" planKey=planKey returnUrl=currentUrl /]" id="addRepository" class="aui-button toolbar-trigger">[@ww.text name="repository.add" /]</a>
                </li>
            </ul>
        </div>
    </div>
...
<script type="text/javascript">
    BAMBOO.REPOSITORY.repositoryConfig.init({
        ...
        repositoryTypesDialog : {
            ...
            isNewAllowed: [#if fn.hasGlobalPermission("CREATEREPOSITORY")]true[#else]false[/#if]
        },
