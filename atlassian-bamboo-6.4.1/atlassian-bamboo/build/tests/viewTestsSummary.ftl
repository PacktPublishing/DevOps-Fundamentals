...
[@dj.tabContainer headingKeys=['build.testSummary.mostFailingTest.title', 'build.testSummary.longestToFix.title',
                               'build.testSummary.longestRunningTest.title', 'build.testSummary.numberOfTests.title']
			...
			<table class="testSummary aui" summary="[@ww.text name="build.testSummary.mostFailingTest.title"/]" id="topTenFailingTests">
                ...
                <tbody>
                    [#list mostFailingTests as testCasePair]
                        ...
                        [@ww.url value=fn.getViewTestCaseHistoryUrl(immutableBuild.key, testCase.id) var='testCaseUrl' /]
                        <tr>
                            ...
                            <td class="recentFailures">
                                ...
                                [#list failures as failurePair]
                                    [@ww.url var='testResultUrl' value=fn.getTestCaseResultUrl(buildKey, failurePair.second, failurePair.first.testCase.id) /]
